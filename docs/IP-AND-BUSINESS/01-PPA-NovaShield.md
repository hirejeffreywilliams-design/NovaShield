...
The platform is implemented in TypeScript using an Express.js server framework with React frontend client, PostgreSQL database accessed through Drizzle ORM, comprising 3,314 lines of active source code across 54 source files organized in a full-stack monorepo architecture.
