      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-14 items-center justify-between border-b border-[#1e1e1e] bg-[#0a0a0a] px-6">
          ...
          <div className="flex items-center gap-4">
            <button className="relative rounded-lg p-2 text-[#a3a3a3] transition-colors hover:bg-[#1e1e1e] hover:text-[#e5e5e5]">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="rounded-lg p-2 text-[#a3a3a3] transition-colors hover:bg-[#1e1e1e] hover:text-[#ef4444]"
                title="Logout"
              >
